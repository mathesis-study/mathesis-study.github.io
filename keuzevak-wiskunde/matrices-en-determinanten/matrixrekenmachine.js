 ...
 * Matrixrekenmachine.maak(houder) aan. Er komt geen MathJax aan te pas, zodat
...
(function () {
  ...
  function maak(houder) {
    ...
    var BEWERKINGEN = [
      { naam: "som", groep: "AB", opschrift: "A + B" },
      { naam: "verschil", groep: "AB", opschrift: "A − B" },
      { naam: "productAB", groep: "AB", opschrift: "A · B" },
      { naam: "productBA", groep: "AB", opschrift: "B · A" },
      { naam: "gelijk", groep: "AB", opschrift: "A = B ?" },
      { naam: "scalairA", groep: "A", opschrift: "r · A" },
      { naam: "transponeerA", groep: "A", opschrift: "Aᵀ" },
      { naam: "machtA", groep: "A", opschrift: "Aⁿ" },
      { naam: "detA", groep: "A", opschrift: "det A" },
      { naam: "scalairB", groep: "B", opschrift: "r · B" },
      { naam: "transponeerB", groep: "B", opschrift: "Bᵀ" },
      { naam: "machtB", groep: "B", opschrift: "Bⁿ" },
      { naam: "detB", groep: "B", opschrift: "det B" }
    ];
    ...
    function bouwKeuze() {
      ...
      [["AB", "met A en B"], ["A", "met A"], ["B", "met B"]].forEach(function (groep) {
        ...
        BEWERKINGEN.filter(function (b) { return b.groep === groep[0]; })
          .forEach(function (b) {
